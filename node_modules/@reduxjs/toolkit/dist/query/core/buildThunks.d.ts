import type { InternalSerializeQueryArgs } from '@reduxjs/toolkit/dist/query/defaultSerializeQueryArgs';
import type { Api, ApiContext } from '../apiTypes';
import type { BaseQueryFn, BaseQueryError } from '@reduxjs/toolkit/dist/query/baseQueryTypes';
import type { RootState, QueryKeys, QuerySubstateIdentifier } from '@reduxjs/toolkit/dist/query/core/apiState';
import type { StartQueryActionCreatorOptions, QueryActionCreatorResult } from '@reduxjs/toolkit/dist/query/core/buildInitiate';
...
export declare function buildThunks<BaseQuery extends BaseQueryFn, ReducerPath extends string, Definitions extends EndpointDefinitions>({ reducerPath, baseQuery, context: { endpointDefinitions }, serializeQueryArgs, api, }: {
    ...
    updateQueryData: UpdateQueryDataThunk<EndpointDefinitions, { [P in ReducerPath]: import("@reduxjs/toolkit/dist/query/core/apiState").CombinedState<any, string, P>; }>;
    upsertQueryData: UpsertQueryDataThunk<Definitions, { [P in ReducerPath]: import("@reduxjs/toolkit/dist/query/core/apiState").CombinedState<any, string, P>; }>;
    patchQueryData: PatchQueryDataThunk<EndpointDefinitions, { [P in ReducerPath]: import("@reduxjs/toolkit/dist/query/core/apiState").CombinedState<any, string, P>; }>;
